...
class RoamMikadoSimpleLineIcons implements iRoamMikadoIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'roam'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'roam'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'roam'),
            'icon-social-facebook'    => esc_html__('Facebook', 'roam'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'roam'),
            'icon-social-github'      => esc_html__('Github', 'roam'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'roam'),
            'icon-social-instagram'   => esc_html__('Instagram', 'roam'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'roam'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'roam'),
            'icon-social-reddit'      => esc_html__('Reddit', 'roam'),
            'icon-social-skype'       => esc_html__('Skype', 'roam'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'roam'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'roam'),
            'icon-social-spotify'     => esc_html__('Spotify', 'roam'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'roam'),
            'icon-social-twitter'     => esc_html__('Twitter', 'roam'),
            'icon-social-youtube'     => esc_html__('Youtube', 'roam')
        );
    }
