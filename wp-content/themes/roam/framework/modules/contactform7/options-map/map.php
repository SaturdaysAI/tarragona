...
if ( ! function_exists('roam_mikado_contact_form_7_options_map') ) {

	function roam_mikado_contact_form_7_options_map() {

		roam_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'roam'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = roam_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'roam')
		));

		//Text Typography

		$typography_text_group = roam_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'roam'),
			'description'	=> esc_html__('Setup typography for form elements text', 'roam'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = roam_mikado_add_admin_row(array(
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'roam'),
		));
		...
		$typography_text_row2 = roam_mikado_add_admin_row(array(
		...
		$typography_text_row3 = roam_mikado_add_admin_row(array(
		...
		$typography_label_group = roam_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'roam'),
			'description'	=> esc_html__('Setup typography for form elements label', 'roam'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = roam_mikado_add_admin_row(array(
		...
		$typography_label_row2 = roam_mikado_add_admin_row(array(
		...
		$background_border_group = roam_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'roam'),
			'description'	=> esc_html__('Setup form elements background and border style', 'roam'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = roam_mikado_add_admin_row(array(
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'roam')
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'roam')
		));

		$background_border_row2 = roam_mikado_add_admin_row(array(
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'roam'),
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'roam')
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'roam')
		));

		$background_border_row3 = roam_mikado_add_admin_row(array(
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'roam'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'roam'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = roam_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'roam'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = roam_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'roam'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'roam'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'roam'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'roam'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = roam_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'roam'),
			'description'	=> esc_html__('Setup form elements margin', 'roam'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = roam_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'roam'),
			'description'	=> esc_html__('Enter height for textarea form element', 'roam'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = roam_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'roam'),
			'description'	=> esc_html__('Setup button text typography', 'roam'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = roam_mikado_add_admin_row(array(
		...
		$button_typography_row2 = roam_mikado_add_admin_row(array(
		...
		$button_background_border_group = roam_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'roam'),
			'description'	=> esc_html__('Setup button background and border style', 'roam'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = roam_mikado_add_admin_row(array(
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'roam')
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'roam')
		));

		$button_background_border_row2 = roam_mikado_add_admin_row(array(
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'roam')
		));
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'roam')
		));

		$button_background_border_row3 = roam_mikado_add_admin_row(array(
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'roam'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		roam_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'roam'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = roam_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'roam')
		));
        ...
        $panel_contact_form_style_3 = roam_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'roam')
        ));
        ...
        $typography_label_row3 = roam_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = roam_mikado_add_admin_row(array(
	...
	add_action( 'roam_mikado_options_map', 'roam_mikado_contact_form_7_options_map', 20);
}