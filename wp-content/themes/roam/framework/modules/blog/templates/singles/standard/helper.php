...
if( !function_exists('roam_mikado_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function roam_mikado_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'roam_mikado_blog_single_holder_classes', 'roam_mikado_get_blog_single_holder_classes' );
}
