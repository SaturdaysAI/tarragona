 ...
 * @param $module_design
 */
function forminator_print_forms_admin_styles( $version = '1.0', $module_type = false, $module_design = false, $form_settings = false ) {
	...
	wp_enqueue_style( 'forminator-ui-grid', forminator_plugin_url() . 'assets/forminator-ui/css/forminator-grid.min.css', array(), $version );
	wp_enqueue_style( 'forminator-ui-global', forminator_plugin_url() . 'assets/forminator-ui/css/forminator-global.min.css', array(), $version );
	wp_enqueue_style( 'forminator-ui-form-styles', forminator_plugin_url() . 'assets/forminator-ui/css/forminator-forms.min.css', array(), $version );
}
...
function forminator_print_polls_admin_styles( $version = '1.0' ) {
	wp_enqueue_style( 'forminator-ui-icons', forminator_plugin_url() . 'assets/forminator-ui/css/forminator-icons.min.css', array(), $version );
	wp_enqueue_style( 'forminator-ui-global', forminator_plugin_url() . 'assets/forminator-ui/css/forminator-global.min.css', array(), $version );
	wp_enqueue_style( 'forminator-ui-poll-styles', forminator_plugin_url() . 'assets/forminator-ui/css/forminator-polls.min.css', array(), $version );
}
...
function forminator_print_front_styles( $version = '1.0' ) {
	...
	wp_enqueue_style( 'forminator-quizzes', forminator_plugin_url() . 'assets/css/front.min.css', array(), $version );
