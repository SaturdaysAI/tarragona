...
class Forminator_Assets_Enqueue_Form extends Forminator_Assets_Enqueue {
	...
	public function enqueue_styles() {
		...
		if ( 'none' !== $form_design ) {
			...
			if ( $has_phone_settings || $has_address_country || $has_select_multiple || $has_select_settings || $has_datepicker || $has_timepicker || $has_uploader || $has_post_feat_image || ( $has_post_categories && $has_multi_categories ) || ( $has_post_tags && $has_multi_tags ) || $has_currency || $has_paypal ) {
