...
$(document).ready(function() {
  ...
  var a,
        ...
        (i = i.split(".").join("")),
          $(g).on(b, function(d) {
            if ((d.preventDefault(), $(f).hasClass("active"))) m.closeNav(p, a);
              ...
              fa || $(".header-inner").css({ top: e + "px" }),
                aa
                  ? ($(c)
                      .addClass(p + " inactive " + a)
                      .css({ transitionTimingFunction: ea[l] }),
                    $(f)
                      .addClass("active " + a)
                      .css({ transitionTimingFunction: ea[l] }))
                  : ($(c).addClass(p),
          ...
          ? (A.state(!0),
            ...
            $(c).on(da, function(a) {
              return (
                ...
                $(c).removeClass("inactive"),
                $(f).removeClass("active"),
                void (fa || $(".header-inner").css({ top: 0 })))
              );
            }))
          : ($(c).removeClass(a + " " + b),
            $(f)
              ...
              $(n).hasClass("active")
                ...
                : ($("body").data("aux-nav", !0),
                  ...
                  aa
                    ? $(n)
                        .addClass("active " + a)
                        .css({ transitionTimingFunction: ea[s] })
                    : $(n).addClass("active"),
                  $(n).on(da, function(a) {
                    return (
                      a.target === $(this)[0] &&
                      (a.stopPropagation(), y.state(!0), void $(this).off(da))
                    );
                  }));
          }),
          $(o).on(b, function(b) {
    ...
    u = ".side-navigation-wrapper nav, .overlay-navigation-wrapper nav",
    v = ".sub-menu",
    w = ".contains-sub-menu",
    x = {
      init: function() {
                  ...
                  (e = a.parent().hasClass("active")
                    ...
                    : setTimeout(function() {
                        var b = a
                          ...
                          .outerHeight();
                        a.closest(I).is("[data-toggle-multiple]") ||
                          (d.removeClass("no-transition").css({ height: 0 }),
                          a
                            .closest(I)
                            .children()
                            .children("li")
              ...
              .on(b, function(a) {
                a.preventDefault(),
                  aa
                    ...
                    : $(this)
                        .parent()
                        .animate({ opacity: 0 }, V, Q, function() {
                          $(this).remove();
                        });
              });
        });
                ...
                $(this)
                  ...
                  .on(b, function(a) {
                    if (
                      ...
                      $(this)
                        .closest(".dropdown")
                        .is("[data-update-selection]"))
                    ) {
                      var b = $(this).text();
                      $(this)
                        .closest(".dropdown")
                        .find(e)
                        .children('span:not([class*="icon-"])')
                        .text(b);
                    }
                  }),
                fa ||
        ...
        aa
          ? $(S).each(function() {
              ...
              if (
                ...
                var i = $(this).data("gradient-spread")
                  ? $(this).data("gradient-spread")
                  : "50%";
                $(this)
                  .find(U)
                  .css({
          ...
          : $(S)
              ...
              .mouseenter(function() {
                $(this)
                  ...
                  .css({ opacity: 0 })
                  .stop()
                  .animate({ opacity: 1 }, V, W);
              })
              .mouseleave(function() {
                $(this)
                  .find(U)
                  .stop()
                  .animate({ opacity: 0 }, V, W);
              });
      },
    ...
    aa =
      void 0 !== _.transition ||
      void 0 !== _.WebkitTransition ||
      void 0 !== _.MozTransition ||
      void 0 !== _.MsTransition ||
      void 0 !== _.OTransition,
    ba = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
  for (var ca in ba)
    void 0 !== _[ba[ca]] &&
      (a = "-" + ba[ca].replace("Transform", "").toLowerCase());
  var da =
...
!(function(a, b, c, d) {
  ...
  function f(b, d, e) {
    ...
    f.each(function() {
      ...
      u(f, d);
      var k = a(
        '<div class="tm-loader"><svg id="circle" viewBox="25 25 50 50"><circle class="stroke" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"/></svg></div>'
      );
      if (
        (i > 0 &&
          (d.lazyLoad
            ? k.appendTo(f)
            : a(b).find(".tm-loader").length || k.appendTo(b)),
        j)
      ) {
        M &&
          f.is("[data-video-bkg]") &&
          f.children("video").css({ display: "none" });
      ...
      i
        ? f.find("img").each(function(b, k) {
            if (
              ((k =
                a(this).attr("srcset") && !a("body").hasClass("ie-browser")
                  ? a(this).prop("currentSrc")
                  : a(this).data("src")
                  ? a(this).data("src")
                  : a(this).attr("src")),
              !a(this).attr("srcset"))
              ...
              ((c.isRetinaDevice() && d.retinaSupport) ||
                (c.isRetinaDevice() && a(this).is("[data-retina]"))) &&
                ((!M && !d.retinaSupportMobile) ||
                  (M && d.retinaSupportMobile)) &&
                (k.match(/\.(svg)/i) ||
                  (k = a(this).data("retina")
                    ? a(this).data("retina")
                    : k.replace(m, d.retinaSuffix + m)));
            }
            if (f.data("overlay-bkg-color") && !f.find(".tms-overlay").length) {
              var n = f.data("overlay-bkg-color").replace("#", ""),
                o = f.data("overlay-bkg-opacity")
                  ? f.data("overlay-bkg-opacity")
                  : 0.5,
                p = parseInt(n.substring(0, 2), 16),
                q = parseInt(n.substring(2, 4), 16),
                r = parseInt(n.substring(4, 6), 16),
                s = "rgba( " + p + "," + q + "," + r + "," + o / 1 + " )",
                t = f.data("image-wrapper")
                  ? f.find("." + f.data("image-wrapper"))
                  : f;
              a('<div class="tms-overlay" />')
                .css({ backgroundColor: s, opacity: 0 })
                .appendTo(t);
            }
            a(this)
              .css({ opacity: 0 })
              ...
              .one("load", function() {
                f.css({ transition: "none", opacity: 0 }),
  ...
  function g(b, c, d, e) {
    var f = b.closest(".tm-slider-container"),
      ...
      k = null,
      l = !(
        !b.is("[data-video-bkg-youtube]") && !b.is("[data-video-bkg-vimeo]")
      );
    if (
      (b.find(".no-transition").css({ visibility: "visible" }),
      f.data("setup", !0),
      f.data("first-load", !1),
      ...
      var n =
        b.children("img").attr("srcset") && !a("body").hasClass("ie-browser")
          ? b.children("img").prop("currentSrc")
          : b.children("img").attr("src");
      n = "undefined" != typeof n ? n : b.children("img").attr("src");
      var p = b.data("image-wrapper") ? b.data("image-wrapper") : b;
      b.data("image-wrapper")
        ? b.find("." + p).css({ "background-image": "url(" + n + ")" })
        : b.css({ "background-image": "url(" + n + ")" }),
        b.children("img").hide();
    }
    if (0 === f.height() && !f.data("height") && b.hasClass("active")) {
      ...
      f.data("refH", q),
        f.css({ height: q + "px" }),
        i.children("img").css({ maxHeight: "100%" });
    }
    if (
      (s(b, d),
      r(f, d),
      d.carousel &&
        !d.lazyLoad &&
        (g.children().css({ opacity: 1 }), g.css({ opacity: 0 })),
      l || b.find("iframe, video").css({ opacity: 1 }),
      c === g.children().length && d.onLoadEnd && d.onLoadEnd(),
      d.lazyLoad || c !== g.children().length
        ? d.lazyLoad &&
          1 === c &&
          (f.data("loaded", !0), d.autoAdvance && e.initSlideshow())
        : (f.data("loaded", !0), d.autoAdvance && e.initSlideshow()),
      d.lazyLoad)
    ) {
      if (
        (((b.find(".tm-loader").length && !l) || M) && h(f, b, d),
        ...
        (l && !M) ||
          ...
          (j = setTimeout(function() {
            i.find(".tms-caption").length > 0 && o(i, d),
              i.find(".tms-content-scalable").length > 0 &&
                a(".tms-content-scalable").css({ opacity: 1 });
          }, 300)));
    } else
      c === g.children().length &&
        (((f.find(".tm-loader").length && !l) || M) && h(f, b, d),
        i.find(".tms-caption").show(),
        d.carouselVisible > 1 && f.find(".tms-caption").show(),
        F
          ? d.carousel
            ? m(g, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", 1e3, 0, "easeIn", d)
            : m(i, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", 1e3, 0, "easeIn", d)
          : d.carousel
          ? g.animate({ opacity: 1 })
          : i.animate({ opacity: 1 }),
  ...
  var i = function(d, g) {
      var h,
        ...
        w = i.fulscreen
          ...
          ? i.scaleUnder
          : o.data("width")
          ? parseFloat(o.data("width"))
          : parseFloat(o.css("width")),
        x = i.fulscreen
          ? a(c).height()
          : o.data("height")
          ? parseFloat(o.data("height"))
          : parseFloat(o.css("height")),
        y = o.find(".tms-slides"),
        z = [];
      y.children(".tms-slide").each(function(b) {
        b++, a(this).attr("id", "tms-slide-" + b), z.push(a(this).attr("id"));
        var c = !!(
          a(this).is("[data-video-bkg]") ||
          a(this).is("[data-video-bkg-youtube]") ||
          a(this).is("[data-video-bkg-vimeo]")
        );
        (i.forceFit || a(this).is("[data-force-fit]") || c) &&
      ...
      if (
        ("" !== E && o.find("#" + E).length
          ? (history.pushState(
            ...
            (A = o.find("#" + E).addClass("active")))
          : (A = y.children("li:first-child").addClass("active")),
        i.carousel ||
          (F
            ? a(this)
                .not(".active")
            ...
            : a(this)
                .not(".active")
                .css({ left: "100%" })),
        i.lazyLoad || A.css({ opacity: 0 }),
        (i.scaleUnder = o.data("scale-under")
          ? o.data("scale-under")
          : i.scaleUnder),
        (i.scaleMinHeight = o.data("scale-min-height")
          ? o.data("scale-min-height")
          : i.scaleMinHeight),
        ...
        (i.carouselVisible = o.data("carousel-visible-slides")
          ? o.data("carousel-visible-slides")
          : i.carouselVisible),
        (i.carouselVisible =
          i.carouselVisible > y.children().length
            ? y.children().length
            : i.carouselVisible),
        (i.showProgressBar =
          !o.is('[data-progress-bar="false"]') && i.showProgressBar),
        (i.autoAdvance = !!o.is("[data-auto-advance]") || i.autoAdvance),
        (i.interval = o.data("auto-advance-interval")
          ? o.data("auto-advance-interval")
          : i.interval),
        (i.pauseOnHover =
          !o.is('[data-pause-on-hover="false"]') && i.pauseOnHover),
        (i.navArrows = !o.is('[data-nav-arrows="false"]') && i.navArrows),
        (i.navPagination =
          !o.is('[data-nav-pagination="false"]') && i.navPagination),
        (i.navShowOnHover =
          !o.is('[data-nav-show-on-hover="false"]') && i.navShowOnHover),
        (i.navKeyboard = !o.is('[data-nav-keyboard="false"]') && i.navKeyboard),
        (o.is("[data-nav-dark]") || A.is("[data-nav-dark]")) &&
          (o.addClass("tms-nav-dark"),
          o.is("[data-featured-slider]") && a("header").addClass("nav-dark")),
        i.fullscreen &&
          (o.css({ top: 0, left: 0 }).addClass("tms-fullscreen"),
          (i.carouselVisible = 1),
          (i.fsUseHeightOf =
            i.fsUseHeightOf || o.data("fs-use-height")
              ? i.fsUseHeightOf && !o.data("fs-use-height")
                ? i.fsUseHeightOf
                : o.data("fs-use-height")
              : ""),
          (i.fsUseHeightOf = i.fsUseHeightOf
            ? "parent" === i.fsUseHeightOf
              ? o.parent()
              : o.closest("." + i.fsUseHeightOf)
            : "")),
        (i.parallax = !!o.is("[data-parallax]") || i.parallax),
        (i.parallaxSpeed = o.data("parallax-speed")
          ? o.data("parallax-speed")
          : i.parallaxSpeed),
        (i.parallaxScale =
          !!o.is("[data-parallax-scale-in]") || i.parallaxScale),
        (i.parallaxFadeOut =
          !!o.is("[data-parallax-fade-out]") || i.parallaxFadeOut),
        ...
        (i.replayOnEnd =
          !o.is('[data-replay-on-end="false"]') && i.replayOnEnd),
        (i.nextSlideOnEnd =
          !!o.is("[data-next-slide-on-end]") || i.nextSlideOnEnd),
        (i.muteBkgVideo = !!o.is("[data-mute-video]") || i.muteBkgVideo),
        M && ((i.autoPlay = !1), (i.useVideoAPI = !1)),
      ...
      if (i.navPagination && y.children().length > 1) {
        for (
          var I = a("<div>")
              .addClass("tms-pagination")
              .appendTo(o),
            J = 1;
          J < y.children().length + 1;
          J++
        )
          o.find(I).append(
        ...
        var L =
          "bullets" === i.paginationType
            ? o.find(".tms-bullet-nav")
            : o.find(".tms-thumb-nav");
        L.each(function() {
          a(this).on("click", function() {
            return (
              ...
              !a(this).hasClass("active") &&
                ...
                parseFloat(I.find(".active").data("index"))
                  ? t.slideTo(a(this).data("index"), "next")
                  : t.slideTo(a(this).data("index"), "prev"),
                !1)
            );
          });
        }),
          I.children()
            .eq(o.find("li.active").index())
            .addClass("active"),
          i.lazyLoad && I.css({ display: "block" });
      }
              ...
              (!N[37] || !N[39]) &&
                void (N[37]
                  ? (i.autoAdvance && o.data("loaded") && t.resetSlideshow(),
                    i.lazyLoad
                      ? t.prevSlide()
                      : o.data("loaded") && t.prevSlide())
                  : N[39] &&
                    (i.autoAdvance && o.data("loaded") && t.resetSlideshow(),
                    i.lazyLoad
                      ? t.nextSlide()
                      : o.data("loaded") && t.nextSlide()))
            );
          })
          .on("keyup", function(a) {
            N[a.keyCode] = !1;
        ...
        a(c).on("scroll", function() {
          o.parent().hasClass("tm-slider-parallax-container") && i.parallax
            ? (a(c).on("scroll", function() {
              ...
              k(o, i))
            : !o.parent().hasClass("tm-slider-parallax-container") &&
              i.parallax &&
              console.log(
          ...
          !M && F && l(o.parent())
            ? b && d && !b.hasClass("video-playing") && v(b, "play", i)
            : b && d && b.hasClass("video-playing") && v(b, "pause", i);
        }),
        o
          .data("setup", !1)
          .data("loaded", !1)
      ...
      (t.initSlideshow = function() {
        return (
          !(O || y.children().length < 2) &&
          ((i.autoAdvance = !0),
          !M &&
            i.pauseOnHover &&
            (y.on("mouseleave ", t.resumeSlideshow),
            y.on("mouseenter ", t.pauseSlideshow)),
          i.showProgressBar &&
            (U = a("<div>")
              .addClass("tms-progress-bar")
              .appendTo(o)),
          t.startSlideshow(),
          X(i.interval),
          (P = new Date().getTime()),
          ...
          (a = a ? R : i.interval),
            (O = setInterval(function() {
              a !== i.interval &&
                ...
                (P = new Date().getTime()),
                "undefined" != typeof U &&
                  U.css({ transition: "none", width: "0px" }),
                X(i.interval),
                t.nextSlide();
            }, a));
        }),
        ...
        (t.endSlideshow = function() {
          return (
            ...
            !M &&
              i.pauseOnHover &&
              (y.off("mouseleave ", t.resumeSlideshow),
      ...
      var X = function(a) {
        return (
          ...
          void (F
            ...
            : U.stop(!0, !0).animate({ width: "100%" }, a))
        );
      };
      (t.nextSlide = function() {
        ...
        if (
          ((b = a.inArray(c, z) + 1 === 0 ? 1 : a.inArray(c, z) + 1),
          i.carousel && i.carouselVisible > 1)
        ) {
          var d = q(o, i);
          1 !== d &&
            (b = b === y.children().length - (d - 2) ? 1 : a.inArray(c, z) + 1);
        }
        this.slideTo(b, "next");
      }),
        ...
        (t.slideTo = function(b, c) {
          ...
          f.addClass("target").css({ zIndex: 2, opacity: 0 === g ? 0 : 1 }),
            A.css({ zIndex: 1 }),
            (i.animation = f.data("animation") ? f.data("animation") : h);
          var g =
              "slide" === i.animation || "slideLeftRight" === i.animation
                ? d
                : 0,
          ...
          var l =
            "scaleIn" === i.animation
              ? 1 - i.scaleFactor
              : "scaleOut" === i.animation
              ? 1 + i.scaleFactor
              : 1;
          o.is("[data-nav-dark]") || o.removeClass("tms-nav-dark"),
            f.is("[data-nav-dark]")
              ? (o.addClass("tms-nav-dark"),
                o.is("[data-featured-slider]") &&
            ...
            o.parent().hasClass("tm-slider-parallax-container") &&
              i.parallax &&
              j(o, i),
            (!f.children("img").data("loaded") && f.children("img").length) ||
              s(f, i),
            r(o, i, f),
            c || (c = "next"),
          ...
          F
            ...
            : (o.data("transitioning", !0),
              f
                .css({ left: d * c + "px", visibility: "visible" })
                .animate(
                  { opacity: 1, left: "0px" },
                  i.speed,
                  i.easingFallback,
    ...
    k = function(b, d) {
      var e = a(c),
        ...
        h = f * d.parallaxSpeed,
        i =
          d.parallaxScale && b.is("[data-parallax-scale-in]")
            ? 0.75 * (2 - g / b.parent().height())
            : 1;
      i = i < 1 ? 1 : i;
      ...
      !M && F && l(b.parent())
        ? b.is("[data-parallax]") &&
          ...
          m.css({ opacity: j.toFixed(2) }),
          m.css({ transform: "scale3d( " + i + "," + i + ", 1 )" }))
        : b.is("[data-parallax]") &&
          b.css({ position: "relative" }).addClass("out-of-view");
    },
    l = function(b) {
      var d = a(c).scrollTop(),
        e = d + a(c).height(),
    ...
    m = function(b, c, d, e, f, g, h, i, j, k, l, m, o, p, q) {
      ...
      (b.hasClass("active") ||
        b.hasClass("target") ||
        b.hasClass("tms-slides")) &&
        (r.data("animate-first-slide") || r.data("transitioning", !0),
    ...
    n = function(a, b) {
      ...
      var c = a.find("li.active"),
        d = a.find("li.target"),
        e = !(
          !d.is("[data-video-bkg-youtube]") && !d.is("[data-video-bkg-vimeo]")
        );
      return (
        v(c, "pause", b),
        1 === b.carouselVisible &&
    ...
    r = function(b, c, d) {
      ...
      g.children().each(function(b) {
        (c.carouselVisible = 0 === c.carouselVisible ? 1 : c.carouselVisible),
          a(this).css({ width: m + "px", opacity: 1, visibility: "visible" }),
    ...
    s = function(b, d) {
      var e = b.closest(".tm-slider-container, .featured-media"),
        ...
        k = e.data("external-padding")
          ? e.data("external-padding")
          : d.externalPadding;
      k = a.isNumeric(k) ? k : 2 * parseFloat(a(k).css("paddingLeft"));
      var l = d.fullscreen || d.fullwidth ? a(c).width() - k : f,
        m = d.fullscreen
          ? g - k
          : d.carousel && d.carouselVisible > 1 && !d.adaptiveHeight
          ? i
          : d.fullwidth && f / j > i
          ? i - k
          : f / j - k,
      ...
      if (
        (e.data("newSW", l), e.data("newSH", m), d.carousel || d.adaptiveHeight)
      ) {
        var r = null;
        clearTimeout(r),
          ...
          (r = setTimeout(function() {
            e.css({
              height:
                e.data("scale-first") && p
                  ? e
                      .find("li:first-child")
                      .find(".tms-content-scalable, img")
                      .outerHeight() + "px"
                  : !e.data("scale-first") && p
                  ? b.find(".tms-content-scalable, img").outerHeight()
                  : "auto"
            });
          }, 100));
      } else
        e.css({
          ...
          height:
            m > d.scaleMinHeight || "auto" === d.scaleMinHeight
              ? Math.round(m) + "px"
              : d.scaleMinHeight + "px"
        }),
      ...
      var s = b.is("[data-image]") ? "image" : "video",
        u = !!(
          b.is("[data-video-bkg]") ||
          b.is("[data-video-bkg-youtube]") ||
          b.is("[data-video-bkg-vimeo]")
        ),
        v = b.is("[data-video-ratio]")
          ? parseFloat(b.data("video-ratio"))
          : 1.778;
      b
        ...
        .each(function() {
          ...
          if (
            ("image" === s
              ...
              : "video" === s &&
                (((!d.respectRatio && !u) || (d.fullscreen && !u)) &&
                  b.addClass("tms-video-no-ratio"),
                u
                  ? ((c = d.fullscreen && d.fullwidth ? h * v : l),
                    (e = d.fullscreen && d.fullwidth ? h : l / v))
                  : ((c =
                      a(this).attr("width") && l > a(this).attr("width")
                        ? a(this).attr("width")
                        : l),
                    (e = q ? c / v : c / v))),
            (f = c / e),
            ...
            o > f
              ? a(this).css({
                  ...
                  top: u
                    ? Math.floor((m - e) / 2) + "px"
                    : Math.round(-((l / f - m) / 2)) + "px",
                  left: u ? -(g / 2) + "px" : 0
                })
              : a(this).css({
                  width:
                    !d.fullwidth || q || u ? Math.round(m * f) + "px" : "auto",
                  height: m + "px",
                  top: 0,
      ...
      return (
        ...
        void b.find(".tms-caption").each(function() {
          if (!a(this).is("[data-no-scale]")) {
            ...
            var C;
            b.find("img, iframe, video").length &&
              (C = e * (j / g) > j ? j : e * (j / g) > e ? e : e * (j / g)),
              b.find("img").length || b.find("iframe, video").length
                ? b.css({
                    width: C + "px",
                    height: b.children("iframe, video").length
                      ? C / 1.778 + "px"
                      : "auto"
                  })
                : b.css({
                    ...
                    borderTopWidth:
                      e * (s / g) > s ? s : Math.ceil(e * (s / g)) + "px",
                    borderRightWidth:
                      e * (t / g) > t ? t : Math.ceil(e * (t / g)) + "px",
                    borderBottomWidth:
                      e * (u / g) > u ? u : Math.ceil(e * (u / g)) + "px",
                    borderLeftWidth:
                      e * (v / g) > v ? v : Math.ceil(e * (v / g)) + "px",
                    whiteSpace: "nowrap"
                  }),
              b.css({
                top:
                  "top" === i
                    ...
                    : "bottom" === i
                    ? f - b.outerHeight() - B
                    : (f - b.outerHeight()) / 2 + B + "px",
                left:
                  "left" === d
                    ? 0 + A
                    : "right" === d
                    ? e - b.outerWidth() - A
                    : (e - b.outerWidth()) / 2 + A + "px"
              });
          }
        })
      );
        ...
        if (b.find("iframe").length) {
          ...
          "undefined" != typeof f && f.indexOf("vimeo") > -1
            ? "play" === c && d.autoPlay
              ...
              : (w[e].pause(), b.removeClass("video-playing"))
            : "undefined" != typeof f &&
              f.indexOf("youtu") > -1 &&
              ((e = e.replace("#", "")),
              "play" === c && d.autoPlay
                ? (x[e].playVideo(), b.addClass("video-playing"))
                : (x[e].pauseVideo(), b.removeClass("video-playing")));
        } else
          b.find("video").length &&
            ((e = "#" + b.find("video").attr("id")),
            "play" === c && d.autoPlay
              ? (a(e)[0].play(), b.addClass("video-playing"))
              : (a(e)[0].pause(), b.removeClass("video-playing")));
      } catch (a) {}
    },
    w = [],
    x = [],
      ...
      if (
        ...
        if (
          (e
            .attr(
              "src",
              e.attr("src").replace("?api=1", "") +
                "?&amp;player_id=" +
                e.attr("id")
            )
            .addClass("vimeo"),
          i.is("[data-video-bkg-vimeo]") &&
            e
              .attr(
                "src",
                e.attr("src") +
        ...
        a(".vimeo").each(function() {
          a(this).on("load", function() {
            ...
            (w[c] = new Vimeo.Player(a(c))),
              ...
              w[c].setVolume(1),
              (f.muteBkgVideo || e.is("[data-mute-video]")) &&
                w[c].setVolume(0),
                ...
                onStateChange: function(a) {
                  a.data === YT.PlayerState.PLAYING &&
                    ...
                    a.data === YT.PlayerState.ENDED &&
                      (f.replayOnEnd && x[c].playVideo(),
                      f.nextSlideOnEnd && g.nextSlide());
                },
                onReady: function(a) {
                  i &&
                    f.autoPlay &&
                    (x[c].playVideo(), e.addClass("video-playing")),
                    (f.muteBkgVideo || e.is("[data-mute-video]")) &&
                      x[c].mute();
                },
                onError: function(a) {
        ...
        t &&
          f.autoPlay &&
          (s.load(), (s.autoplay = !0), i.addClass("video-playing")),
          s.addEventListener("playing", function() {
            i.addClass("video-bkg-loaded");
          }),
          (f.muteBkgVideo || i.is("[data-mute-video]")) &&
            (s.muted = f.muteBkgVideo);
        var u = function(a) {
  ...
  (navigator.userAgent.match(/Android/i) ||
    ...
    (M = !0);
  var N =
    (b.all && b.addEventListener) ||
    ("-ms-scroll-limit" in b.documentElement.style &&
      "-ms-ime-align" in b.documentElement.style);
  N &&
    !a("body").hasClass("ie-browser") &&
    (b.getElementsByTagName("body")[0].className += " ie-browser"),
    (function() {
      for (
        var a = 0, b = ["ms", "moz", "webkit", "o"], d = 0;
        d < b.length && !c.requestAnimationFrame;
        ++d
      )
        (c.requestAnimationFrame = c[b[d] + "RequestAnimationFrame"]),
          (c.cancelAnimationFrame =
            c[b[d] + "CancelAnimationFrame"] ||
            c[b[d] + "CancelRequestAnimationFrame"]);
  ...
  var e = function(b, d) {
      ...
      k.on("click", function(b) {
        b.preventDefault(),
          ...
          (e.lightboxAnimation = a(this).data("lightbox-animation")
            ? a(this).data("lightbox-animation")
            : e.lightboxAnimation),
          (e.contentAnimation = a(this).data("content-animation")
            ? a(this).data("content-animation")
            : e.contentAnimation),
          (e.modalAnimation = a(this).data("modal-animation")
            ? a(this).data("modal-animation")
            : e.modalAnimation),
          (e.contentMargin = a(this).data("content-margin")
            ? a(this).data("content-margin")
            : e.contentMargin),
          (e.navExit = !a(this).is('[data-nav-exit="false"]') && e.navExit),
          (e.videoRatio = a(this).data("video-ratio")
            ? a(this).data("video-ratio")
            : e.videoRatio),
          (e.auxClasses = a(this).data("aux-classes")
            ? a(this).data("aux-classes")
            : e.auxClasses),
          i(p, e, k, l);
      }),
        ...
        (l.destroyLightbox = function() {
          ...
          if (s) {
            ...
            c.remove(),
              b.animate(
                { opacity: 0, left: f.x + "px", top: f.y + "px" },
                e.speed,
                e.easing,
                function() {
                  b.find("iframe").attr("src", ""), b.remove(), (b = null);
    ...
    f = function(b) {
      ...
      var d = b.data("launch-delay") ? b.data("launch-delay") : 0,
        e = b.is("[data-set-cookie]")
          ? b.data("set-cookie")
          : b.data("delete-cookie");
      b.is("[data-set-cookie]")
        ? z.hasItem(e) ||
          (z.setItem(e, "Fri, 31 Dec 9999 23:59:59 GMT", "/"), c())
        : b.is("[data-delete-cookie]") && z.hasItem(e)
        ? (z.removeItem(e), c())
        : c();
    },
    g = function(b) {
    ...
    h = function(b, d) {
      var e = d.lightboxAnimation,
        f =
          "slideInLeft" === e || "slideInTop" === e
            ? -1
            : "slideInRight" === e || "slideInBottom" === e
            ? 1
            : 0,
    ...
    i = function(d, e, f, g) {
      ...
      var i = a("#tm-lightbox"),
        ...
        o = null;
      if (
        (i.addClass(e.auxClasses.replace(/,/g, " ")), f.is("[data-modal-mode]"))
      ) {
        i.addClass("tml-modal-mode");
        var p =
          "slideInTop" === e.modalAnimation
            ? "slide-in-top"
            : "slideInBottom" === e.modalAnimation
            ? "slide-in-bottom"
            : "scaleIn" === e.modalAnimation
            ? "scale-in"
            : "scaleOut" === e.modalAnimation
            ? "scale-out"
            : "fade";
        l.addClass("modal-dialog").addClass(p),
          ...
          f.data("modal-height") &&
            i.data("modal-height", f.data("modal-height"));
      }
      i.data("initLoad", !0);
      ...
      if (e.navExit) {
        var u;
        (u = i.hasClass("tml-modal-mode")
          ? a('<a href="" id="tml-exit" class="tml-nav" />').appendTo(l)
          : a('<a href="" id="tml-exit" class="tml-nav" />').appendTo(i)),
      ...
      if (e.navToolbar) {
        ...
        if (
          ((e.navZoom = f.is("[data-toolbar]")
            ? a.inArray("zoom", F) > -1
            : e.navZoom),
          (e.navShare = f.is("[data-toolbar]")
            ? a.inArray("share", F) > -1
            : e.navShare),
          e.navZoom &&
            ((x = a(
          ...
          var H = f.data("networks")
            ? String(f.data("networks")).split(";")
            : e.navNetworks.split(",");
      ...
      e.navKeyboard &&
        a(b).on("keyup", function(a) {
          37 == a.keyCode && d.length >= 2
            ? g.prevContent()
            : 39 == a.keyCode && d.length >= 2
            ? g.nextContent()
            : 27 == a.keyCode && g.destroyLightbox();
        }),
        e.overlayClickClose &&
          i.on("click", function(a) {
            (a.target !== this && "tml-content-wrapper" !== a.target.id) ||
              g.destroyLightbox();
          });
      var I = h(i, e);
      if (s) {
    ...
    k = function(b, d, e) {
      ...
      var j = b.is("a") ? b.attr("href") : "#" + b.attr("id"),
        ...
        n =
          b.is('[data-content="inline"]') ||
          (b.is("[data-modal-mode]") && !b.is('[data-content="iframe"]')),
        o = b.is('[data-content="iframe"]'),
        p = b.is('[data-content="ajax"]');
      if (
        (a("#tml-loader").length && a("#tml-loader").remove(),
        f.append(
          '<div id="tml-loader" class="tm-loader"><svg id="circle" viewBox="25 25 50 50"><circle class="stroke" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"/></svg></div>'
        ),
        k)
      ) {
        var q = j.substr(j.lastIndexOf("."));
        ((c.isRetinaDevice() && e.retinaSupport) ||
          (c.isRetinaDevice() && b.is("[data-retina]"))) &&
          ((!y && !e.retinaSupportMobile) || (y && e.retinaSupportMobile)) &&
          (j.match(/\.(svg)/i) ||
            (j = b.data("retina")
              ? b.data("retina")
              : j.replace(q, e.retinaSuffix + q))),
          g.data("type", "img"),
          a("<img />")
            .addClass("tml-image")
            .attr("src", j)
      ...
      if (n)
        if (
          (g.addClass("scrollable-content").data("type", "inline"), a(j).length)
        ) {
          var s = a(j)
            .clone(!0)
            .addClass("show")
      ...
      if (o) {
        ...
        var t = a(
          '<iframe src="' + j + '" frameborder="0" scrolling="auto" />'
        );
        g.html(t),
          t.one("load", function() {
            l(!0, d, e);
    ...
    m = function(b) {
      ...
      if (
        ...
        (l = i.find("img").width()), (m = i.find("img").height());
    ...
    o = function(b, c) {
      ...
      e
        ? (d.html(a("<span />").text(e)),
          s
            ? n(a("#tml-caption"), b, 0, 0, c)
            : a("#tml-caption").animate({ opacity: b }))
        : d.html("");
    };
  c.isRetinaDevice = function() {
    var a =
...
!(function(a, b, c, d) {
  ...
  function e(b, d) {
    ...
    ((c.isRetinaDevice() && d.retinaSupport) ||
      ...
      (h.match(/\.(svg)/i) ||
        (h = b.data("retina")
          ? b.data("retina")
          : b.data("src").replace(i, d.retinaSuffix + i))),
  ...
  function f(b, d) {
    ...
    e.css({ "background-image": "url(" + g + ")" }),
      ...
      o && k(b)
        ...
        : e.css({ visibility: "visible" }).animate({ opacity: 1 }),
      a(c)
        .on("resize", function() {
          i(b, d), h(b, d);
        })
  ...
  var g = function(b, c) {
    ...
    i = function(b, d) {
      ...
      return (
        (d.fullscreen || d.scaleContainer) && e.css({ height: g + "px" }),
        ...
        if (
          (o
            ? e
                ...
                .removeClass("out-of-view")
            : e.css({ top: i + "px", visibility: "visible" }),
          d.fadeInOut)
        ) {
          var j,
            l = a(c).height(),
            m =
              d.fadeThreshold > 1
                ? 0.5 * b.height()
                : b.height() * d.fadeThreshold;
          g <= m && (j = Math.abs(f / m) > 1 ? 1 : Math.abs(f / m)),
            g <= l && g >= l - m && (j = (l - g) / m > 1 ? 1 : (l - g) / m),
            e.css({ opacity: (Math.ceil(100 * j) / 100).toFixed(2) });
        }
...
!(function(a, e, t, i) {
  ...
  var n,
    r = function(e, n) {
      ...
      (e = a(e)),
        w && e.css({ opacity: 1, visibility: "visible" }),
  ...
  var b = function(b, c) {
    ...
    (h.startCounter = function() {
      ...
      var a = g.data("count-from") ? parseFloat(g.data("count-from")) : f.from,
        ...
        c = g.data("count-interval")
          ? parseFloat(g.data("count-interval"))
          : f.interval,
        i = a <= b ? "up" : "down";
      e = setInterval(function() {
        (a === b || isNaN(a) || isNaN(b)) &&
          (clearInterval(e), f.onComplete && f.onComplete()),
          g.text(d(a)),
          "up" === i ? a++ : a--;
      }, c);
    }),
      (h.clearCounter = function() {
        clearInterval(e);
        var a = g.data("count-from")
          ? parseFloat(g.data("count-from"))
          : f.from;
        g.html(a);
      }),
      (h.startCountdown = function() {
        var b = g.data("countdown-date")
            ? new Date(g.data("countdown-date")).getTime()
            : new Date(f.toDate).getTime(),
        ...
        var j = function(a) {
          ...
          k = function() {
            ...
            if (
              (g.html(
                '<span class="unit"><span class="day">' +
                  j(f.days) +
                  '</span><span class="unit-type">' +
                  d +
                  '</span></span> <span class="unit"><span class="hour">' +
                  j(f.hours) +
                  '</span><span class="unit-type">' +
                  e +
                  '</span></span> <span class="unit"><span class="min">' +
                  j(f.minutes) +
                  '</span><span class="unit-type">' +
                  h +
                  '</span></span> <span class="unit"><span class="sec">' +
                  j(f.seconds) +
                  '</span><span class="unit-type">' +
                  i +
                  "</span></span>"
      ...
      "stat" == f.mode
        ...
        : "countdown" == f.mode && f.autoStart && h.startCountdown();
  };
        ...
        .each(function() {
          ...
          if (
            ...
            "img" ==
              ...
              "undefined" != typeof e(this).attr("src") &&
              (t = e(this).attr("src"));
...
!(function(a, b, c, d) {
  ...
  var e = function(d, e) {
      ...
      (g.useCSS = !!d.is("[data-use-css]") || g.useCSS),
        (g.extraSpaceTop = d.data("extra-space-top")
          ? d.data("extra-space-top")
          : "auto" != d.css("top")
          ? parseInt(d.css("top"), 10)
          : g.extraSpaceTop),
        (g.extraSpaceBottom = d.data("extra-space-bottom")
          ? d.data("extra-space-bottom")
          : g.extraSpaceBottom),
        (g.pushSection = d.data("push-section")
          ? d.data("push-section")
          : g.pushSection),
        (g.threshold = d.data("threshold") ? d.data("threshold") : g.threshold);
      var j = (a(c).scrollTop(), d.offset().top),
        k = !1;
      i && g.useCSS
        ? d.css({ top: g.extraSpaceTop + "px" })
        : (h(d, g),
          d
            .data("startup", !0)
            .data("orignDistance", j)
            .css({ width: "100%", display: "flex", flexDirection: "column" }),
          a(c).on("scroll resize", function() {
            f(d),
              d.data("startup") || h(d, g),
              a(c).width() >= g.breakpoint && k
                ? ((k = !1), (j = d.offset().top), d.data("orignDistance", j))
                : a(c).width() < g.breakpoint && (k = !0);
          }),
    ...
    g = function(b, d) {
      ...
      if (e >= 960) {
        var f = a(c).scrollTop(),
          ...
          h = b.outerHeight(!0),
          i = Math.abs(
            a(d.pushSection).offset().top - (g + h) + d.extraSpaceTop
          ),
          j = g - f - d.extraSpaceTop,
          k =
            g + (a(d.pushSection).offset().top - (g + h)) - f - d.extraSpaceTop;
        j <= 0 || (j <= 0 && b.data("startup"))
          ? (b.addClass("sticky").css({
              maxWidth:
                a(b)
                  .parent()
                  .width() + "px",
          ...
          : (f <= b.offset().top - d.extraSpaceTop &&
              b.addClass("sticky").css({
                maxWidth:
                  a(b)
                    .parent()
            ...
            b.offset().top <= g &&
              b
                .removeClass("sticky")
                .css({ maxWidth: "", position: "", top: "", zIndex: "" }));
      } else
    ...
    i = function(a, b) {
      j(a, b) || a.data("startup")
        ? a.removeClass("out-of-view")
        : a.addClass("out-of-view"),
        g(a, b),
        a.data("scrolling", !1);
    },
    j = function(b, d) {
...
!(function(a, b, c, d) {
  ...
  var e = function(b, d) {
    ...
    var f = function(b) {
      ...
      g = function(a, b) {
        var c = h[b]
          .replace(/{url}/g, a.data("url"))
          .replace(/{title}/g, a.data("title"))
          .replace(/{description}/g, a.data("description"))
          .replace(/{image}/g, a.data("image"))
          .replace(/{user}/g, a.data("user"));
        f(c);
      },
      h = {
        pinterest:
        ...
        twitter:
          "https://twitter.com/share?url={url}&via={user}&text={description}",
        googleplus: "https://plus.google.com/share?url={url}",
        linkedin:
          "https://www.linkedin.com/shareArticle?url={url}&title={title}&summary={description}+&source={user}"
      };
    b.on("click", function(c) {
      "email" == a(this).data("network")
        ? a(this).attr(
            "href",
            "mailto:" +
              a(this).data("email") +
              ...
              a(this).data("subject") +
              "&body=" +
              a(this).data("description") +
              " - " +
              a(this).data("url")
          )
        : (c.preventDefault(), g(b, b.data("network")));
    });
  };
...
$(document).ready(function() {
  ...
  var a = ".header",
    ...
    Da =
      ".no-page-fade, .no-page-fade a, .side-nav-show, .overlay-nav-show, .mail-link, .lightbox-link, .contains-sub-menu, .blog .pagination-previous, .blog .pagination-next, .disabled, .scroll-link, .navigation-show a, a.navigation-show, .social-list a",
    Ea = ".socialize",
    Fa = 800,
    Ga = 600,
    Ha =
    ...
    Ia = {
      init: function() {
        ...
        try {
          document.getElementsByClassName("map-canvas") &&
            google.maps.event.addDomListener(window, "load", Ia.googleMap);
        } catch (a) {}
        Ia.fixedFooter(),
          Ia.pageFade(),
          Ia.scrollToSection(),
      ...
      horizon: function(a, b, c, d, e) {
        return (
          ...
          void $(a)
            .not(b)
            .horizon({ easing: c, recurring: d, threshold: e })
        );
      },
      freeze: function(a) {
            ...
            if ($(k).find(l).length > 1) {
              ...
              if (c) {
                ...
                f.each(function() {
                  $(this).on("click", function(b) {
                    ...
                    (a = $(this).attr("href")), Ia.scrollPage(a, 0);
                  });
                });
              }
              $(window).on("scroll", function() {
              ...
              var g = function(a) {
                ...
                h = function(a) {
                  ...
                  c && Ia.isElementVisible($(k), p)
                    ? $(b).css({ opacity: 1, visibility: "visible" })
            ...
            $(l).each(function() {
              ...
              if ($(this).is("[data-width],[data-height]"))
                if ($("body").hasClass("mobile") || c <= 768) {
                  ...
                  (j = g && j <= g ? g : j),
                    a.css({ height: "auto" }),
                    d.css({ height: j + "px", minHeight: j + "px" });
                } else
                  a.removeClass("fs-image-scale"),
                    a.css({ height: "" }),
                    d.css({ height: "", minHeight: "" });
              else
      ...
      scrollToSection: function() {
        ...
        var e = function(a) {
          ...
          f = function(a) {
            var b =
              "header, .header-sub, .side-navigation-wrapper, .overlay-navigation-wrapper, .scroll-navigation";
      ...
      masonry: function() {
        $(q).each(function() {
          ...
          if (
            (c.hasClass("fade-in-progressively") &&
              d.children().addClass("no-transition"),
            "*" !== e &&
              ($(s)
                .find(".active")
                .removeClass("active"),
              ...
              imagesLoaded(d, function() {
                d.isotope({
                  ...
                  $("body").hasClass("transition-support") &&
                    d.children().removeClass("no-transition");
                var f = d.children().length - 1;
                d.children().each(function(a) {
                  if (
                    c.is("[data-as-bkg-image]") &&
                    c.is("[data-set-dimensions]") &&
                    !$(this).find(".background-image").length
                  ) {
                    var b = $(this).find("img"),
                      d = $(this)
                        .find("img")
                        .attr("style"),
                      e =
                        b.attr("srcset") && !$("body").hasClass("ie-browser")
                          ? b.prop("currentSrc")
                          : b.attr("src");
                    $(
                      '<span class="background-image background-cover" style="' +
                        d +
                        '" />'
                    )
            ...
            $(g)
              ...
              $.ajax({ url: h, type: i, data: j, dataType: "json" })
                .done(function(a) {
                  try {
                    a.response === !0
                      ? (c.text(W), c.delay(1500).fadeOut(200), d.val(""))
                      : c
                          .hide()
                          .text(a.json.error_message)
                          .fadeIn(200);
                  } catch (a) {
            ...
            $(g)
              ...
              $.ajax({ url: h, type: i, data: j, dataType: "json" })
                .done(function(a) {
                  try {
                    if (a.response === !0)
                      c.text(da), c.delay(1500).fadeOut(200), d.val("");
                    else {
                      var b =
      ...
      googleMap: function() {
        $(ha).each(function() {
          ...
          (ka = $(this).data("icon")
            ...
            : ka),
            (la = $(this).data("coordinates")
              ? $(this).data("coordinates")
              : la),
            (ma = $(this).data("info")
              ? JSON.parse("[" + $(this).data("info") + "]")
              : ma),
            (pa = $(this).data("zoom-level")
          ...
          for (var f, g, h = 0, i = 0; i < la.length; i++)
            (f = new google.maps.Marker({
              ...
              google.maps.event.addListener(
                ...
                (function(a, b) {
                  return function() {
                    g.setContent(e, ma[b]), g.open(e, a);
                  };
                })(f, i)
              ),
              h++;
      ...
      fixedFooter: function() {
        function a() {
          $(za).hasClass(d) &&
            $(window).width() > 960 &&
            $(xa).css({ marginBottom: c + "px" }),
            $(za).is("[data-animate-reveal]") &&
              ((b = $(xa).outerHeight() + e - $(window).scrollTop()),
              b <= $(window).height() && $(window).width() > 960
                ? $(xa).addClass("animate-content")
                : $(xa).removeClass("animate-content"));
        }
        if ($("body").hasClass("mobile")) return !1;
        var b,
          c = $(ya).outerHeight(),
      ...
      socialize: function() {
        $(Ea).socialize({ winWidth: Fa, winHeight: Ga });
      },
